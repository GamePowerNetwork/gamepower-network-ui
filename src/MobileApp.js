    ...
    <React.Fragment>
        ...
        <div className="parallax-wrapper">
          ...
          <div className="content" style={{textAlign: "center"}}>
            ...
            <p className="intro">GamePower will be the first fully decentralized game publishing platorm built on Kusama and Polkadot. Discover new games, freely trade your digital games and earn rare collectibles with REAL WORLD value.</p>
          </div>
        </div>
